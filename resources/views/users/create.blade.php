    ...
    <form action="{{ isset($user) ? route('users.update', $user) : route('users.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="registration-header">
            <div class="registration-title">
                <h1>{{ isset($user) ? 'Editar Cadastro' : 'Cadastro de Novo Aluno' }}</h1>
                <p>Registre as informações fundamentais para iniciar a jornada do novo praticante.</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1.8fr_1fr] gap-6 items-start">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="start_date" class="form-control" value="{{ old('start_date', isset($user) && $user->start_date ? $user->start_date->format('Y-m-d') : date('Y-m-d')) }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            <div class="section-header" style="justify-content: space-between;">
                ...
                <div class="plan-header-badge">Plano ativo imediatamente</div>
            </div>
        ...
        <div class="footer-help">
            Ao salvar este cadastro, um e-mail de boas-vindas será enviado automaticamente ao aluno com as instruções de acesso ao sistema.
        </div>
